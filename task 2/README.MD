...
| Source  | Library                                             | Function Utilized     | Times Used |
| ------- | --------------------------------------------------- | --------------------- | ---------- |
| opdef.c | include/linux/build_bug.h                           | BUILD_BUG_ON          | 2          |
|         | io_uring/opdef.c                                    | io_eopnotsupp_prep    | 1          |
|         | io_uring/opdef.h                                    | io_uring_optable_init | 1          |
|         | arch/mips/include/asm/bug.h                         | BUG_ON                | 2          |
|         | io_uring/opdef.h                                    | io_uring_op_supported | 1          |
|         | drivers/gpu/drm/xe/xe_gsc.h                         | prep                  | 1          |
|         | include/linux/io_uring.h                            | io_uring_get_opcode   | 1          |
|         | arch/alpha/kernel/perf_event.c                      | ARRAY_SIZE            | 3          |
|         | io_uring/opdef.c                                    | io_no_issue           | 1          |
|         | drivers/gpu/drm/amd/amdgpu/amdgpu_amdkfd_arcturus.c | WARN_ON_ONCE          | 2          |

### openclose.c
| Source      | Library                                             | Function Utilized        | Times Used |
| ----------- | --------------------------------------------------- | ------------------------ | ---------- |
| openclose.c | io_uring/filetable.h                                | io_fixed_fd_install      | 1          |
|             | io_uring/opdef.c                                    | io_openat2_prep          | 1          |
|             | include/linux/file.h                                | __get_unused_fd_flags    | 1          |
...
|             | include/linux/io_uring.h                            | io_is_uring_fops         | 1          |
|             | io_uring/opdef.c                                    | io_close_prep            | 1          |
...
|             | arch/arm64/include/asm/fpsimd.h                     | flush                    | 1          |
|             | io_uring/openclose.c                                | io_close_fixed           | 2          |
|             | io_uring/opdef.c                                    | io_close                 | 1          |
...
|             | io_uring/opdef.c                                    | io_install_fixed_fd      | 1          |
|             | fs/file.c                                           | files_lookup_fd_locked   | 1          |
|             | io_uring/opdef.c                                    | io_install_fixed_fd_prep | 1          |
|             | io_uring/opdef.c                                    | io_open_cleanup          | 1          |
...
|             | io_uring/openclose.c                                | __io_openat_prep         | 3          |
|             | drivers/gpu/drm/gma500/framebuffer.c                | IS_ERR                   | 2          |
|             | io_uring/openclose.h                                | __io_close_fixed         | 2          |
...
|             | io_uring/opdef.c                                    | io_openat_prep           | 1          |
...
|             | io_uring/opdef.c                                    | io_openat                | 1          |

### poll.c
| Source | Library                                             | Function Utilized              | Times Used |
| ------ | --------------------------------------------------- | ------------------------------ | ---------- |
| poll.c | drivers/usb/class/cdc-wdm.c                         | spin_lock_irq                  | 2          |
|        | include/linux/list.h                                | hlist_for_each_entry           | 2          |
|        | .vmlinux.export.c                                   | add_wait_queue_exclusive       | 1          |
|        | io_uring/opdef.c                                    | io_poll_remove_prep            | 1          |
...
|        | io_uring/poll.c                                     | __io_arm_poll_handler          | 3          |
...
|        | io_uring/poll.c                                     | io_async_queue_proc            | 1          |
...
|        | io_uring/poll.c                                     | __io_poll_cancel               | 2          |
...
|        | io_uring/poll.c                                     | io_poll_wake                   | 4          |
...
|        | io_uring/poll.c                                     | __io_poll_execute              | 6          |
...
|        | arch/m68k/include/asm/atari_joystick.h              | wait                           | 1          |
|        | arch/x86/kernel/cpu/resctrl/pseudo_lock.c           | GENMASK                        | 1          |
|        | drivers/android/binder.c                            | wake_up_pollfree               | 2          |
...
|        | io_uring/opdef.c                                    | io_poll_remove                 | 1          |
...
|        | io_uring/poll.c                                     | __io_queue_proc                | 3          |
|        | io_uring/poll.c                                     | io_poll_queue_proc             | 1          |
...
|        | io_uring/opdef.c                                    | io_poll_add_prep               | 1          |
...
| Source     | Library                                             | Function Utilized            | Times Used |
| ---------- | --------------------------------------------------- | ---------------------------- | ---------- |
| register.c | io_uring/sqpoll.h                                   | io_put_sq_data               | 2          |
...
|            | drivers/gpu/drm/vmwgfx/ttm_object.c                 | __releases                   | 1          |
|            | io_uring/msg_ring.h                                 | io_uring_sync_msg_ring       | 1          |
|            | io_uring/register.c                                 | IORING_MAX_RESTRICTIONS      | 1          |
...
|            | drivers/gpu/drm/vmwgfx/ttm_object.c                 | __acquires                   | 1          |
|            | io_uring/register.c                                 | COPY_FLAGS                   | 1          |
|            | drivers/gpu/drm/amd/display/include/vector.h        | struct_size                  | 1          |
...
|            | io_uring/register.c                                 | __io_register_iowq_aff       | 3          |
|            | io_uring/io-wq.h                                    | io_wq_cpu_affinity           | 1          |
|            | io_uring/register.c                                 | __io_uring_register          | 2          |
...
|            | include/linux/syscalls.h                            | SYSCALL_DEFINE4              | 1          |
...
|            | kernel/sys_ni.c                                     | io_uring_register            | 1          |
...
| Source | Library                                             | Function Utilized                | Times Used |
| ------ | --------------------------------------------------- | -------------------------------- | ---------- |
| rsrc.c | io_uring/rsrc.h                                     | io_rsrc_cache_free               | 1          |
...
|        | io_uring/rsrc.c                                     | __io_sqe_files_update            | 2          |
...
|        | io_uring/rsrc.h                                     | io_register_rsrc                 | 1          |
...
|        | io_uring/opdef.c                                    | io_files_update_prep             | 1          |
...
|        | arch/powerpc/include/asm/io.h                       | yet                              | 1          |
...
|        | io_uring/rsrc.h                                     | __io_account_mem                 | 2          |
...
|        | io_uring/rsrc.c                                     | io_release_ubuf                  | 1          |
...
|        | io_uring/openclose.h                                | __io_close_fixed                 | 1          |
...
| Source | Library                                             | Function Utilized                | Times Used |
| ------ | --------------------------------------------------- | -------------------------------- | ---------- |
| rw.c   | io_uring/rw.c                                       | io_req_rw_cleanup                | 5          |
|        | io_uring/rw.c                                       | io_async_buf_func                | 1          |
...
|        | io_uring/opdef.c                                    | io_readv_writev_cleanup          | 1          |
|        | io_uring/rw.c                                       | io_req_io_end                    | 3          |
|        | io_uring/rw.c                                       | __io_import_rw_buffer            | 2          |
...
|        | io_uring/opdef.c                                    | io_prep_write_fixed              | 1          |
|        | io_uring/alloc_cache.h                              | io_alloc_cache_put               | 1          |
...
|        | io_uring/opdef.c                                    | io_read_mshot_prep               | 1          |
|        | drivers/hv/mshv_eventfd.c                           | vfs_poll                         | 1          |
|        | arch/s390/hypfs/inode.c                             | write_iter                       | 2          |
...
|        | io_uring/opdef.c                                    | io_read_mshot                    | 1          |
...
|        | unknown                                             | io_iopoll_complete               | 1          |
|        | include/linux/uio.h                                 | __import_iovec                   | 1          |
...
|        | io_uring/io_uring.h                                 | req_has_async_data               | 1          |
|        | io_uring/rw.h                                       | io_req_rw_complete               | 1          |
|        | drivers/gpu/drm/amd/amdgpu/amdgpu_amdkfd_arcturus.c | WARN_ON_ONCE                     | 1          |
...
|        | arch/arm/include/asm/tls.h                          | until                            | 1          |
...
|        | io_uring/opdef.c                                    | io_prep_readv_fixed              | 1          |
...
|        | io_uring/opdef.c                                    | io_prep_writev_fixed             | 1          |
...
|        | io_uring/rsrc.h                                     | io_import_reg_vec                | 1          |
|        | io_uring/opdef.c                                    | io_prep_read_fixed               | 1          |
...
| Source   | Library                                             | Function Utilized     | Times Used |
| -------- | --------------------------------------------------- | --------------------- | ---------- |
| splice.c | io_uring/rsrc.c                                     | io_put_rsrc_node      | 1          |
|          | io_uring/splice.c                                   | __io_splice_prep      | 3          |
|          | io_uring/opdef.c                                    | io_tee                | 1          |
|          | include/linux/io_uring_types.h                      | io_kiocb_to_cmd       | 6          |
|          | .vmlinux.export.c                                   | fput                  | 2          |
|          | io_uring/opdef.c                                    | io_splice_cleanup     | 1          |
|          | io_uring/cancel.c                                   | io_ring_submit_lock   | 1          |
...
|          | io_uring/opdef.c                                    | io_splice_prep        | 1          |
...
|          | io_uring/opdef.c                                    | io_splice             | 1          |
|          | io_uring/opdef.c                                    | io_tee_prep           | 1          |
